            ...
            <div id="add-customer-modal"
                ...
                <div class="bg-current p-10 rounded-lg shadow-lg w-full max-w-xl">
                    {{-- <div class="w-1/2">
                        ...
                        <p class="text-center text-sm  px-10 text-gray-400">Pastikan data yang ada masukkan sudah benar
                            dan
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#services-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.cabang.getCabang') }}',
                columns: [{
                        data: null,
                        name: 'iteration',
...

                    {
                        ...
                        render: function(data, type, row) {
                            return `<a href="" class="main-item-data text-black hover:text-black-500 font-bold">${data}</a>`;

            ...
            <div class="flex justify-between mb-4 sm:mb-5">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-700"
                        onclick="window.location.href='{{ route('admin.sparepart.create') }}'">
                        Tambah Sparepart
                    </button>
                </div>
            ...
            <form action="{{ route('cs.sparepart.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="button" class="px-4 py-2 bg-gray-500 text-white rounded mr-2"
                        onclick="document.getElementById('add-sparepart-modal').classList.add('hidden')">Kembali</button>
    ...
    <div id="edit-sparepart-modal"
        ...
        <div class="bg-white p-10 rounded-lg shadow-lg w-200 flex">
            <div class="w-1/2">
                ...
                <p class="text-center text-sm mt-2 px-10 text-gray-400">Pastikan data yang ada masukkan sudah benar dan
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var table = $('#spareparts-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('admin.sparepart.getSpareparts') }}',
                    data: function(d) {

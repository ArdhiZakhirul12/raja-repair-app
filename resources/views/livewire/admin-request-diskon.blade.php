    ...
    <div class="w-2/6 pl-4 ">
        ...
        @endif
            ...
            <div class="flex mb-2">
                ...
                <p class="text-blue-500">{{ 'Rp ' . number_format($booking->diskon, 0, ',', '.') }}
            ...
            @if ($isDiskon == true)
                ...
                <div class="mr-2">
                    <label for="diskon" class="block text-sm font-medium text-gray-400">jumlah diskon disetujui</label>
                    <input type="text" wire:model="diskon" id="diskon" name="diskon" 

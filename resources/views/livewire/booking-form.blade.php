        ...
        <div>
                <div class="max-w-4xl mx-3 p-6 bg-white shadow-md rounded-lg">
                    ...
                    <div x-data="{
                        ...
                        <div class="flex space-x-4 mb-4">
                            <div class="w-1/2">
                                <!-- Dropdown Merk HP -->
                                <label for="dropdown" class="block text-sm font-medium text-gray-400">Pilih Merk HP</label>
            ...
            get displayText() {
                ...
                return this.selectedItems.map(i => i.nama_servis).join(', ') || 'Pilih Layanan';
                            ...
                            <label for="dropdown" class="block text-sm font-medium text-gray-400">Pilih Layanan</label>
                            <input type="text" x-model="search" x-on:click="open = !open" x-on:input="open = true"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"

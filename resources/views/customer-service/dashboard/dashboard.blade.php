    ...
    <div class="m-6">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end">
                ...
                <!-- Add view button -->
                <button
                    class="btn bg-blue-400 text-white hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            {{-- <x-dashboard.dashboard-card-01 title="Pendapatan" total="{{ $total_pendapatan }}" />
            <x-dashboard.dashboard-card-01 title="Pendapatan Servis" total="Rp {{ number_format($pendapatan_servis, 0, ',', '.') }}" />
            <x-dashboard.dashboard-card-01 title="Pendapatan Sparepart" total="Rp {{ number_format($pendapatan_sparepart, 0, ',', '.') }}" /> --}}
            ...
            {{-- <x-dashboard.dashboard-card-06-uang title="Pendapatan Servis" total="Rp {{ number_format($pendapatan_servis, 0, ',', '.') }}" /> --}}
            {{-- <x-dashboard.dashboard-card-01 title="Customer" total="Rp {{ number_format($pendapatan_servis, 0, ',', '.') }}" />
            <x-dashboard.dashboard-card-01 title="Teknisi" total="Rp {{ number_format($pendapatan_sparepart, 0, ',', '.') }}" />

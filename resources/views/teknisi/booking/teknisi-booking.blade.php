                        ...
                        <div class="border rounded bg-white flex items-center mb-4">
                            ...
                            <div class="w-2/3 p-4 flex items-center">
                                <div class="mr-6">
                                    ...
                                    <p class="text-gray-400">{{ $booking->hpModel->hpMerk->merk }}, {{ $booking->hpModel->model }}</p>
                                </div>
                            ...
                            <div class="w-1/3 p-4 flex justify-end">
                                <button class="bg-white hover:bg-blue-700 font-bold py-2 px-4 rounded shadow" onclick="window.location.href='{{ route('teknisi.booking.show', $booking->id) }}'">
                                    Detail
                                </button>
                            </div>
                        </div>

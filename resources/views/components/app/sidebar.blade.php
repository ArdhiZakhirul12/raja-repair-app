    ...
    <div id="sidebar"
        ...
        <div class="flex justify-between mb-10 pr-3 sm:px-2">
            ...
            <a class="block" href="{{ route('dashboard') }}">
                <img class="w-20" src="{{ asset('images/raja_repair.svg') }}" alt="Logo">
                    ...
                    <a href="{{ route('admin.diskon.index') }}" :active="request() - > routeIs('admin.diskon.index')">
                        <div class="flex items-center justify-between p-3">
                            <div class="flex items-center">
                                ...
                                <span
                                    class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Diskon Request</span>
                            </div>
                        </div>
                    </a>
